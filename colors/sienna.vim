...
" custom stuff
hi QT guifg=#709000 gui=bold
hi SpecialSymbols guifg=#666666

hi DebugBreak guibg=darkred guifg=white ctermbg=darkred ctermfg=white
hi DebugStop guibg=lightgreen guifg=white ctermbg=lightgreen ctermfg=white

hi OverLength guibg=#DDBFBF guifg=#333333
